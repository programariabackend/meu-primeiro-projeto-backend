...
app.use(router.get('/mulheres', mostraMulheres)) //configurei rota GET /mulhres
app.use(router.post('/mulheres', criaMulher)) //configurei rota POST /mulhres
app.listen(porta, mostraPorta) //servidor ouvindo a porta
app.use(router.patch('/mulheres/:id', corrigeMulher)) //configurei rota PATCH /mulhres/:id
